    ...
    <footer className={styles.footer}>
      <div className={`container mx-auto ${styles.container}`}>
        <div className={styles.grid}>
          <div>
            ...
            <p className={styles.description}>
              Admin panel pentru gestionarea platformei E.I.S. Service.
              Gestionează categorii, prestatori și clienți.
            </p>
		...
		C23.307,19.268,23.307,18.533,23.214,18.38z"
          ...
          <div>
            <h4 className={styles.sectionTitle}>Admin Panel</h4>
            <ul className={styles.linkList}>
              ...
              <li>
                <Link to="/providers" className={styles.link}>
                  <svg
                    className={styles.linkIcon}
                    fill="none"
                    stroke="currentColor"
          ...
          <div>
            ...
            <ul className={styles.linkList}>
              ...
              <li>
                <a href="/solicita-serviciu" className={styles.link}>
                  <svg
                    className={styles.linkIcon}
                    fill="none"
                    stroke="currentColor"
              ...
              <li>
                <a href="/devino-prestator" className={styles.link}>
                  <svg
                    className={styles.linkIcon}
                    fill="none"
                    stroke="currentColor"
              ...
              <li>
                <a href="/despre" className={styles.link}>
                  <svg
                    className={styles.linkIcon}
                    fill="none"
                    stroke="currentColor"
        ...
        <div className={styles.copyright}>
          <p>
            &copy; {new Date().getFullYear()} E.I.S. Admin Panel. Toate
