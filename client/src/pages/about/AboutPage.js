          ...
          <div className={styles.sectionContent}>
            <div className={styles.textContent}>
              <p className={styles.paragraph}>
                eisservice.ro este platforma ta de încredere pentru a găsi rapid
                și eficient profesioniști verificați în toată România. Misiunea
                noastră este de a conecta clienții cu specialiști calificați
                pentru o gamă largă de servicii, de la reparații casnice la
                proiecte complexe.
              </p>
              <p className={styles.paragraph}>
            ...
            <div className={styles.missionIntro}>
              <div className={styles.missionText}>
                <p className={styles.missionParagraph}>
                  Credem în puterea comunității și în importanța serviciilor de
                  calitate. Indiferent dacă ai nevoie de un electrician, un
                ...
                <p className={styles.missionParagraph}>
                  ...
                  accesează servicii profesionale în România, construind o punte
                  solidă între cerere și ofertă, bazată pe încredere,
            ...
            <div className={styles.valuesSection}>
              <div className={styles.valuesGrid}>
                ...
                <div className={styles.valueCard}>
                  ...
                  <div className={styles.valueCardContent}>
                    <p className={styles.valueDescription}>
                      Transparența și încrederea sunt fundamentale în relațiile
                      noastre. Fiecare prestator este verificat riguros, iar
                      sistemul nostru de evaluări și recenzii îți permite să
                      alegi cu încredere profesionistul potrivit pentru nevoile
                      tale specifice.
                    </p>
                  </div>
                </div>
                ...
                <div className={styles.valueCard}>
                  ...
                  <div className={styles.valueCardContent}>
                    <p className={styles.valueDescription}>
                      Platforma noastră este proiectată pentru eficiență maximă.
                      În doar câteva minute poți găsi și contacta profesioniști
                      calificați, economisind timp și efort. Procesul nostru
                      simplificat te conectează rapid cu soluțiile de care ai
                      nevoie.
                    </p>
                  </div>
                </div>
          ...
          <div className={styles.companyContent}>
            <div className={styles.companyText}>
              ...
              >
                ...
                <motion.p className={styles.mapDescription} variants={fadeInUp}>
                  Ne găsești la sediul nostru din Brașov. Vezi harta de mai jos
                  pentru indicații precise.
                </motion.p>
                <motion.div
