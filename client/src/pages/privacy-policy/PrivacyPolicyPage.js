...
const PrivacyPolicyPage = () => {
  ...
  return (
    <>
      <Meta
        title="Politica de Confidențialitate - eisservice.ro | Protecția Datelor Personale"
        description="Descoperă cum protejăm datele dumneavoastră personale pe eisservice.ro. Politica de confidențialitate GDPR-compliant pentru E.I.S. SERVICE COMPLETE S.R.L. Transparență, securitate și respectarea drepturilor dumneavoastră."
        url="https://eisservice.ro/privacy-policy"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "WebPage",
          name: "Politica de Confidențialitate - eisservice.ro",
          description:
            "Politica de confidențialitate GDPR-compliant pentru platforma eisservice.ro",
          url: "https://eisservice.ro/privacy-policy",
          publisher: {
            "@type": "Organization",
              ...
              <div className={styles.zohoInfo}>
                <div className={styles.zohoCard}>
                  ...
                  <p>
                    ...
                    gestionarea comunicărilor prin email. Zoho Corporation este
                    un furnizor de servicii cloud recunoscut la nivel global, cu
                ...
                <div className={styles.zohoDetails}>
                  ...
                  <ul>
                    ...
                    <li>
                      <strong>Backup și Redundanță:</strong> Zoho menține copii
                      de siguranță pentru continuitatea serviciului
                    </li>
                    <li>
                ...
                <div className={styles.dataTransfer}>
                  ...
                  <p>
                    Datele dumneavoastră pot fi procesate pe servere Zoho
                    situate în afara Uniunii Europene. Acest transfer se
                    realizează în baza{" "}
                    <strong>clauzelor contractuale standard</strong> aprobate de
            ...
            <div className={styles.content}>
              <div className={styles.purposes}>
                ...
                <div className={styles.purpose}>
                  ...
                  <p>
                    <strong>Temei legal:</strong> Consimțământul (poate fi
                    retras oricând)
                  </p>
                </div>
              </div>
            ...
            <div className={styles.content}>
              <div className={styles.rights}>
                <div className={styles.right}>
                  ...
                  <p>
                    Puteți solicita o copie a tuturor datelor personale pe care
                    le deținem despre dumneavoastră.
                  </p>
                </div>
                ...
                <div className={styles.right}>
                  ...
                  <p>
                    Puteți cere limitarea prelucrării datelor în anumite
                    situații.
                  </p>
                </div>
                ...
                <div className={styles.right}>
                  ...
                  <p>
                    Puteți primi datele într-un format structurat pentru
                    transfer la alt operator.
                  </p>
                </div>
            ...
            <div className={styles.content}>
              <div className={styles.securityMeasures}>
                <div className={styles.securityItem}>
                  <h4>🔐 Criptare</h4>
                  <p>
                    Toate datele sunt transmise prin conexiuni criptate
                    HTTPS/TLS și stocate în format securizat.
                  </p>
                </div>
                ...
                <div className={styles.securityItem}>
                  ...
                  <p>
                    Monitorizăm constant sistemele pentru detectarea și
          ...
          <section className={styles.section}>
            ...
            <div className={styles.content}>
              <p>
                ...
                Vă vom notifica despre modificările importante prin email sau
                prin afișarea unui anunț pe site-ul nostru.
              </p>
              <p>
                Vă recomandăm să consultați periodic această pagină pentru a fi
                la curent cu cele mai recente informații despre cum vă protejăm
                datele.
              </p>
            </div>
          </section>
